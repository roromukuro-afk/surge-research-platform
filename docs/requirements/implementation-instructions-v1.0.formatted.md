<!--
【整形版 — 原文ではない】
原文: implementation-instructions-v1.0.original.txt（SHA-256 は docs/prompts/MANIFEST.md）
閲覧用に、節番号の行を見出し(##)にし、箇条書き記号を "- " に揃えた。文言を変える意図はないが、原文との照合は original.txt で行うこと。
-->
