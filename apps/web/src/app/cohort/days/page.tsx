...
import { type Day, type RunRecord, loadDays, loadRuns, stopReason, cohortName } from "@/lib/shadow/model";
...
export default async function Runs({ searchParams }: { searchParams: Promise<{ cohort?: string }> }) {
